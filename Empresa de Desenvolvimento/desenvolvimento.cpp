...
public:
    ...
    bool capaz(Projeto P){
        if (P.requisito_programacao <= habilidade_programacao )
        {
            return true;
        }
        else 
...
public:
    ...
    bool capaz(Projeto P){
         if (P.requisito_design <= habilidade_design)
        {
            return true;
        }
        else
...
int main(){
    ...
    for(int i=0;i<N;i++){
        ...
        if (programador.capaz(projeto) == true && designer.capaz(projeto) == true){
